...
/// <summary>
/// Command to update an existing connection between clubs.
/// </summary>
public class UpdateConnectionCommand : ICommand<Result<ConnectionDto>>
{
    /// <summary>
    /// Gets or sets the ID of the connection to update.
    /// </summary>
